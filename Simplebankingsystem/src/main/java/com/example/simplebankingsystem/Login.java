...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblerror.setFont(new java.awt.Font("Segoe UI Emoji", 1, 14)); // NOI18N
        ...
        nameset.setBackground(new java.awt.Color(255, 255, 255));
        nameset.setFont(new java.awt.Font("Segoe UI Emoji", 1, 36)); // NOI18N
        nameset.setForeground(new java.awt.Color(0, 0, 0));
        nameset.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jPanel1.add(nameset, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 40, 270, 50));
        ...
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 30, 220, 80));
        ...
        try{
            ...
            if (rs3.next()) {
                ...
                if(cnumber.equals("")||pnumber.equals("")){  
                    lblerror.setText("Provide complete information");
                }else if(cnumber.length()>16){
                    lblerror.setText("Card number is not more than 16 digits");
                }else if(pnumber.length()>4){
                    lblerror.setText("PIN is not more than 4 digits");
                }else if(cnumber.length()==16 && pnumber.length()==4){
                    lblerror.setText("");
                }
                else if(cnumber.equals(checkcard)&&pnumber.equals(checkpin)){
